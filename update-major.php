...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tb_major SET major_name=%s WHERE major_id=%s",
...
$colname_RecordsetMajor = "-1";
if (isset($_GET['major_id'])) {
  $colname_RecordsetMajor = $_GET['major_id'];
}
mysql_select_db($database_connectioneq, $connectioneq);
$query_RecordsetMajor = sprintf("SELECT * FROM tb_major WHERE major_id = %s", GetSQLValueString($colname_RecordsetMajor, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="major_name" value="<?php echo htmlentities($row_RecordsetMajor['major_name'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td><input type="submit" value="แก้ไข" />
      	<a href="detail-major.php">
      	<button type="button" class="submitss" style="background-color:#F00">ยกเลิก</button>
      	</a>      </td>
    </tr>
  </table>
  <input type="hidden" name="MM_update" value="form1" />
  <input type="hidden" name="major_id" value="<?php echo $row_RecordsetMajor['major_id']; ?>" />
</form>
</div>
</body>
</html>
