...
$query_RecordsetM = "SELECT * FROM tb_stores";
...
<form id="form-detail" name="form-detail" method="post" action="">
<table border="1" width="110%">
  <tr>
        <tr>
          <th colspan="1" style="background-color:#395FEA" width="80%">รายชื่อที่เก็บอุปกรณ์</th>
          <th colspan="1" style="background-color: #666" width="10%">ตัวเลือก</th>
        </tr>
  <tr>
    <th>สถานที่เก็บอุปกรณ์</th>
    <th style="background-color:#FFF">
      <a href="insert_store.php">
      <button type="button">เพิ่ม</button>
      </a>    </th>
  </tr>
  <?php do { ?>
    <tr>
      <td><?php echo $row_RecordsetM['stores_name']; ?></td>
      <td><a href="delete-store.php?stores_id=<?php echo $row_RecordsetM['stores_id']; ?>">
        <button type="button" onclick="return confirm('ยืนยันการลบ <?php echo $row_RecordsetM['stores_name']; ?>')">ลบ</button>
      </a>        <a href="update-store.php?stores_id=<?php echo $row_RecordsetM['stores_id']; ?>">
      <button type="button">แก้ไข</button>
      </a></td>
    </tr>
    <?php } while ($row_RecordsetM = mysql_fetch_assoc($RecordsetM)); ?>
    </tr>
</table>
</form>
</div>
