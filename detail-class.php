...
$query_RecordsetClass = "SELECT * FROM tb_class ORDER BY class_name ASC";
$RecordsetClass = mysql_query($query_RecordsetClass, $connectioneq) or die(mysql_error());
$row_RecordsetClass = mysql_fetch_assoc($RecordsetClass);
$totalRows_RecordsetClass = mysql_num_rows($RecordsetClass);
?>
...
<table border="1" width="110%">
  <tr>
      <tr>
          <th colspan="1" style="background-color:#395FEA">
          รายชื่อชั้นปี</th>
  ...
  <tr>
    <th>ชั้นปี</th>
    <th ><a href="insert-class.php">
      <button type="button">เพิ่ม</button>
    </a></th>
  </tr>
  <?php do { ?>
    <tr>
      <td><?php echo $row_RecordsetClass['class_name']; ?></td>
      <td><a href="delete-class.php?class_id=<?php echo $row_RecordsetClass['class_id']; ?>">
        <button onclick="return confirm('ยืนยันการลบ <?php echo $row_RecordsetClass['class_name']; ?>')">ลบ</button>
      </a></td>
    </tr>
    <?php } while ($row_RecordsetClass = mysql_fetch_assoc($RecordsetClass)); ?>
    </tr>
</table>
</div>
</div>
...
<?php
mysql_free_result($RecordsetClass);
?>
