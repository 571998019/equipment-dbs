...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tb_class (class_name) VALUES (%s)",
...
<p style="text-align:center;"><b>เพิ่มปีการศึกษา</b></p>
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
  <table align="center">
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">ปี :</td>
      <td><input type="text" name="class_name" placeholder=" เช่น 57"/>
	</td> 
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input class="btn btn-success" type="submit" value="เพิ่มข้อมูล" />
      	<a href="detail-class.php">
