...
<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>&user_id=<?php echo $row_Recordset1['id_log']; ?>">
           <div class=" w3-row w3-border" style=" padding-bottom:20px;padding-top:20px; background-color:#CCC">
            <div class="w3-half" align="right" style="padding-right:5px">
               <table border="0">
               <tr>
                    <th colspan="2" style="font-size:20px">รายระเอียดคนยืมอุปกรณ์
                ...
                <tr valign="baseline">
                  ...
                  <td><input name="Borrower_class" type="text" disabled="disabled" value="<?php echo $row_Recordset1['class_name']; ?>" size="32"  /></td>
                </tr>
                
                <tr valign="baseline">
                  <td nowrap="nowrap" align="right">สำนักวิชา/คณะ :</td>
                  <td><input type="text" disabled="disabled" name="Borrower_faculty" value="<?php echo $row_Recordset1['faculty_name']; ?>" size="32"  /></td>
                </tr>
                
                <tr valign="baseline">
                  <td nowrap="nowrap" align="right">สาขา :</td>
                  <td><input type="text" disabled="disabled" name="Borrower_major" value="<?php echo $row_Recordset1['major_name']; ?>" size="32"  /></td>
                </tr>
                
                 <tr valign="baseline">
                  <td nowrap="nowrap" align="right">เบอร์โทร :</td>
                  <td><input type="text" disabled="disabled" name="Borrower_tel" value="<?php echo $row_Recordset1['tel_log']; ?>" size="32"  /></td>
                </tr>
                 

               </table> 
           </div>
           <div class="w3-half" align="left" style="padding-left:5px">
            <table>
                 <tr>
                <th colspan="2" style="font-size:20px">รายระเอียดอุปกรณ์ที่ยืม
            ...
            <tr>
              ...
              <tr valign="baseline">
                 ...
                 <tr valign="baseline">
                  ...
                  <td><input type="text" disabled="disabled" name="tool_type" value="<?php echo $row_RecordsetTool['type_name']; ?>" size="32"  /></td>
                </tr>
                
                <tr valign="baseline">
                  <td nowrap="nowrap" align="right">สถานที่จัดเก็บ :</td>
                  <td><input type="text" disabled="disabled" name="tool_store" value="<?php echo $row_RecordsetTool['stores_name']; ?>" size="32"  /></td>
                </tr>
			...
			?>
            <label for="dates_b">วันที่ยืม : <?php echo date("d/m/Y"); ?></label><br/>
