...
<body style="background-color:#666">
    ...
    <h2 style="text-align:center" >ลงชื่อ ระบบยืม-คืนอุปกรณ์</h2>
        <div style="background-color:#FFF">   
            ...
            <div align="center">
            <label><b>Computer Engineering</b></label><br /> 
            <p>Chiang Rai Rajabhat University</p>
            <p>Center for Microwave and Robotic Technology</p>
            <p style="text-align:center">&copy; 2017  Mirot</p>
            </div>
</body>
</html>