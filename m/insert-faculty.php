...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tb_faculty (faculty_name) VALUES (%s)",
...
<p style="text-align:center;"><b>เพิ่ม คณะ/สำนัก</b></p>
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">คณะ/สำนัก:</td>
      <td><input type="text" name="faculty_name" value="" size="20" /></td>
    </tr>
        <tr valign="baseline">
