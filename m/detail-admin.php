...
<div class="contrainer" style="padding-top:10px; padding-left:5px; padding-right:5px; padding-bottom:20px">
<table border="1" width="110%">
<tr>
	<tr>
          <th colspan="3" style="background-color:#395FEA">รายชื่อผู้ดูแล</th>
  ...
  <?php do { ?>
    <tr>
      ...
      <td><a href="info-admin.php?id_admin=<?php echo $row_Recordsetadmin['id_admin']; ?>"><?php echo $row_Recordsetadmin['admin_name']; ?></a></td>
