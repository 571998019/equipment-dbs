...
$query_RecordsetFaculty = "SELECT * FROM tb_faculty";
...
<title>รายละเอียด สำนัก/คณะ</title>
<style>
table {
...
<tr>
	<tr>
          <th colspan="1" style="background-color:#395FEA">รายชื่อ สำนัก/คณะ</th>
          <th width="10%" style="background-color:#666">ตัวเลือก</th>
        </tr>
  <tr>
    <th>สำนัก/คณะ</th>
    <th><a href="insert-faculty.php">
      <button type="button">เพิ่ม</button>
    </a></th>
  </tr>
  <?php do { ?>
    <tr>
      <td><?php echo $row_RecordsetFaculty['faculty_name']; ?></td>
      <td>
      <a href="delete-faculty.php?faculty_id=<?php echo $row_RecordsetFaculty['faculty_id']; ?>">
      <button type="button" onclick="return confirm('ยืนยันการลบ <?php echo $row_RecordsetFaculty['faculty_name']; ?>')">ลบ</button>
      </a>
      <a href="update-faculty.php?faculty_id=<?php echo $row_RecordsetFaculty['faculty_id']; ?>">
      <button>แก้ไข</button>
      </a>      </td>
    </tr>
    <?php } while ($row_RecordsetFaculty = mysql_fetch_assoc($RecordsetFaculty)); ?>
    </tr>
</table>
</div>
</div>
