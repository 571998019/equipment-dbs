...
<table border="1" width="110%">
  <tr>
        <tr>
          <th colspan="7" style="background-color:#395FEA">รายชื่อผู้ใช้งาน</th>
  ...
  <?php do { ?>
    <tr>
      <td><?php echo $row_RecordsetUser['name_log']; ?></td>
      <td><?php echo $row_RecordsetUser['personal_id']; ?></td>
      <td><?php echo $row_RecordsetUser['student_id_log']; ?></td>
      <td><?php echo $row_RecordsetUser['class_name']; ?></td>
      <td><?php echo $row_RecordsetUser['faculty_name']; ?></td>
      <td><?php echo $row_RecordsetUser['major_name']; ?></td>
      <td><?php echo $row_RecordsetUser['tel_log']; ?></td>
      <td>
            <a href="delete.php?id_log=<?php echo $row_RecordsetUser['id_log']; ?>">
            <button onclick="return confirm('ยืนยันการลบ <?php echo $row_RecordsetUser['name_log']; ?>')">ลบ</button>
            </a>
